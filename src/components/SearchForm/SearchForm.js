...
const SearchForm = () => {
  ...
  const onSubmitButtonClick = (e) => {
    ...
    if (
      ...
      (fromYear.value === toYear.value && parseInt(toQuater.value[1]) < parseInt(fromQuater.value[1]))
    ) {
      let options = {};
      options = {
        place: "tr",
    ...
    console.log(search.value, fromYear.value, toYear.value, fromQuater.value, toQuater.value);
  };
  return (
    <>
